...
file = 'L2_after_i2_cdhit_structured.fasta'
...
for clade, sequences in clade_sequences.items():
    ...
    csv_filename = f"./result/{file.split('_')[0]}/csv/{clade_name}_structured_{file.split('_')[0]}.csv"
    ...
    # Save plot to file
    plot_filename = f"./result/{file.split('_')[0]}/png/{clade_name}_structured_{file.split('_')[0]}.png"
