...
file_list = ['L2_after_i5_cdhit_structure.fasta', 'L2_after_i5_cdhit_IDR.fasta']
...
csv_filename = "./L2_dipeptide_proportions.csv"
...
# csv_filename = "./L2_dipeptide_proportions.csv"  # Ensure this matches your saved file
